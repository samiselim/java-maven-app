...
def commitChanges(){
    echo "Committing changes to github repository"
     withCredentials([usernamePassword(credentialsId: 'sami_credentials', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
        ...
        sh 'git branch'
        sh 'git config --list'
        sh 'git remote set-url origin https://samiselim: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@github.com/samiselim/java-maven-app.git'
        sh 'git add .'
