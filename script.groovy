...
def commitChanges(){
    echo "Committing changes to github repository"
     withCredentials([usernamePassword(credentialsId: 'sami_credentials', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
        ...
        sh 'git branch'
        sh 'git config --list'
        sh 'git remote set-url origin https://samiselim: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@github.com/samiselim/java-maven-app.git'
        sh 'git add .'
