...
def commitChanges(){
    echo "Committing changes to github repository"
     withCredentials([usernamePassword(credentialsId: 'sami_github_cred', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
        ...
        sh " git remote set-url origin https://samiselim:${PASS}@github.com/samiselim/java-maven-app.git"
        sh 'git add .'
